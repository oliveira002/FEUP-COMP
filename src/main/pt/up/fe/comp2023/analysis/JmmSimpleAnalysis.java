...
public class JmmSimpleAnalysis implements JmmAnalysis {
    ...
    public JmmSemanticsResult semanticAnalysis(JmmParserResult jmmParserResult) {
        ...
        List<SemanticAnalysisVisitor> visitors = Arrays.asList(new ArrayAccess(),new OperationSemantics(), new ConditionSemantics(), new ReturnSemantics(), new MethodSemantics());
